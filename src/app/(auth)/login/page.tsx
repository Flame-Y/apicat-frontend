    ...
    return (
        <div class="flex w-full max-w-md flex-col rounded-lg bg-white px-4 py-8 shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
            ...
            <div class="item-center flex gap-4">
                ...
                >
                    <svg class="mb-0.5 mr-2" viewBox="0 0 16 16" width="20" height="20" fill="currentColor">
                    ...
                    <div class="mb-2 flex flex-col">
                        <div class="relative flex ">
                            ...
                            <input
                                type="text"
                                id="sign-in-email"
                                class=" w-full flex-1 appearance-none rounded-r-lg border border-gray-300 bg-white px-4 py-2 text-base text-gray-700 placeholder-gray-400 shadow-sm transition duration-200 ease-in focus:border-transparent focus:outline-none focus:ring-2 focus:ring-yellow-600"
