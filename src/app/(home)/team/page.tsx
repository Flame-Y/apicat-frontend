...
import { GetTeamListAPI } from '@/app/api/team/api';
...
export default function Team() {
    ...
    function getTeamList(token: string) {
        GetTeamListAPI(token).then((res) => {
            console.log(res);
        });
    }
    useEffect(() => {
    ...
    return (
        <div className="flex h-screen bg-white py-6 sm:py-8 lg:py-12">
            <div className="mx-auto max-w-screen-xl overflow-auto px-4 md:px-8">
                ...
                {/* TODO: 将小组信息封装成组件注入 */}
                <div className="grid grid-cols-2 gap-x-4 gap-y-8 overflow-auto md:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
                    <div>
