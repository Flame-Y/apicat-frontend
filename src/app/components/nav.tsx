                ...
                <nav className="mt-6">
                    <div>
                        ...
                        >
                            ...
                            <span className="mx-4 text-sm">团队</span>
                        </Link>
                        <Link
                            className={`${
                        ...
                        >
                            ...
                            <span className="mx-4 text-sm">项目</span>
                        </Link>
                        <Link
                            className={`${
                        ...
                        >
                            ...
                            <span className="mx-4 text-sm">通知</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="mx-4 text-sm">个人信息</span>
                        </Link>
                        <Link
                            className={`${
                                pathName === '/setting'
                        ...
                        >
                            ...
                            <span className="mx-4 text-sm">设置</span>
                        </Link>
                    </div>
                </nav>
            </div>
